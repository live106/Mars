...
public class ResponseUserLogin implements org.apache.thrift.TBase<ResponseUserLogin, ResponseUserLogin._Fields>, java.io.Serializable, Cloneable, Comparable<ResponseUserLogin> {
   ...
   * @see LoginCode
   */
  public LoginCode code; // required
   ...
   * @see LoginCode
   */
  public ResponseUserLogin setCode(LoginCode code) {
    this.code = code;
    return this;
  }
  ...
  public ResponseUserLogin setMsg(String msg) {
    this.msg = msg;
    return this;
  }
        ...
        switch (schemeField.id) {
          case 1: // CODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.code = thrift.pojo.LoginCode.findByValue(iprot.readI32());
